  ...
  return (
    <div className="flex flex-col h-screen whatsapp-bg overflow-hidden font-body">
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-8 space-y-4 max-w-3xl mx-auto w-full">
        {/* Date Divider */}
        <div className="flex justify-center my-6 animate-in fade-in zoom-in duration-700 delay-300 fill-mode-both">
        ...
        <div className="flex justify-center max-w-sm mx-auto animate-in fade-in slide-in-from-top-4 duration-700 delay-700 fill-mode-both">
        ...
        {/* Message 2 */}
        <div className="flex items-end gap-2 max-w-[85%] animate-in fade-in slide-in-from-left-6 duration-500 delay-[2000ms] fill-mode-both">
          <div className="w-8 h-8 rounded-full bg-[#005c4b] hidden sm:flex items-center justify-center overflow-hidden shrink-0 border border-white/10">
            <Image 
              src="https://picsum.photos/seed/elite/100/100" 
              alt="Avatar" 
        ...
        {/* Quick Reply Buttons */}
        <div className="flex flex-wrap gap-2 justify-center py-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-[3000ms] fill-mode-both">
